...
# moves object files to original folders
mv port.o ./drivers/
mv screen.o ./drivers/
mv util.o ./kernel/
mv idt.o ./cpu/
...
i386-elf-ld -o kernel.bin -Ttext 0x1000 kernel_entry.o interrupt.o kernel/kernel.o drivers/port.o drivers/screen.o kernel/util.o cpu/idt.o cpu/isr.o --oformat binary
